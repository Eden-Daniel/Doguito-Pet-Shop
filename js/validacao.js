...
const mensagensDeErro = {
    ...
    senha: {
        valueMissing: 'O campo de senha não pode estar vasio.',
...
function checaEstruturaCPF(cpf){
    ...
    return checaDigitoVerificado(cpf, multiplicador)
}

function checaDigitoVerificado(cpf ,multiplicador){
    if(multiplicador >= 12){
        return true
    }
    ...
    if(digitoVerificado == confirmaDigito(soma)){
        return checaDigitoVerificado(cpf, multiplicador + 1)
    }
...
function preencheCamposCPF(data) {
